...
{
	@Getter private static File dataFolder = new File(Main.getInstance().getDataFolder().getAbsolutePath() + "/data/");
	@Getter public static YamlConfiguration config;
	public static File configFile = new File(Main.getInstance().getDataFolder(), "config.yml");

	@Getter public static YamlConfiguration messages;
